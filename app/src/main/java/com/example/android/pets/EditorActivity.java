...
//Get user input from editor and save it into the database
    private void savePet()
    {
       ...
       if(TextUtils.isEmpty(nameString))
       {
        ...
        int petWeight = 0;
        if (!TextUtils.isEmpty(weightString)) { petWeight = Integer.parseInt(mWeightEditText.getText().toString().trim()); }
        if(TextUtils.isEmpty(breedString)){breedString="Unknown Breed";}
        ...
        if(currentPetUri==null) {
            ...
            int rowsAffected = getContentResolver().update(PetContract.PetEntry.CONTENT_URI, values, null, null);
    ...
    private void deletePet() {
        ...
        if(rowsDeleted==0)
        {
            Toast.makeText(this, "Error with deleting the pet", Toast.LENGTH_SHORT).show();
        }
        else{
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        String[] projection = {PetContract.PetEntry._ID, PetContract.PetEntry.COLUMN_PET_NAME, PetContract.PetEntry.COLUMN_PET_BREED, PetContract.PetEntry.COLUMN_PET_GENDER
